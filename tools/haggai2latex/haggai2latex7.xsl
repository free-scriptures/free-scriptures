...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="XMLBIBLE">
    <xsl:text>\documentclass[a5paper]{article}&#xA;</xsl:text>
    <xsl:text>% This file was generated by haggai2latex7.xsl, which is free software licensed under the GNU Affero General Public License 3 or any later version (see https://github.com/free-scriptures/free-scriptures/ and http://www.free-scriptures.org).&#xA;</xsl:text>
    <xsl:text>&#xA;</xsl:text>
...
{%
  ...
  \ifnum13818639>\number\zposx{#1}%
    ...
    \else%
      \ifnum#2&gt;99%
        \hbox to 0pt{\hskip\dimexpr-\zposx{#1}sp +0.36in \relax#2}%
      \else
        \hbox to 0pt{\hskip\dimexpr-\zposx{#1}sp +0.43in \relax#2}%
      \fi
    \fi
  \else%
