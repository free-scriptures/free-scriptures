...
public class vpl2haggai1
{
    public static void main(String args[])
    {
        ...
        String programPath = vpl2haggai1.class.getProtectionDomain().getCodeSource().getLocation().getPath();
        ...
        try
        {
            ...
            while (line != null)
            {
                ...
                writer.write("      <VERSE vnumber=\"" + verseNr + "\">" + EscapeXMLTextContent(line.substring(posVerse + 1)) + "</VERSE>\n");
